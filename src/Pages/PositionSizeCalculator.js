...
const PositionSizeCalculator = () => {
    useEffect(() => {
        ...
        script.onload = () => {
            ...
            const remoteCalcData = {
                ...
                ContainerId: "position-size-calculator-899647"
            };
    ...
    return (
        <div className='positionsizecal1'>
            <Sidebar />
            <div className='positionsizecal2' style={{ display: 'flex', flexDirection: 'column', alignItems: 'center',
             justifyContent: 'center', minHeight: '100vh', marginTop:"105px"}}>
                <div id="position-size-calculator-899647"></div>
            </div>
            <Footor />
        </div>
